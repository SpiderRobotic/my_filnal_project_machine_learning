...
st.markdown('<h1 class="header-text">NHẬN DẠNG TRÁI CÂY</h1>', unsafe_allow_html=True)
...
uploaded_file = st.file_uploader("Choose a image.bmp file", type="bmp")
...
if uploaded_file is not None:
    ...
    press = st.button('Bắt đầu nhận dạng')
    if press:
